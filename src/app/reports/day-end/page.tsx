  ...
  return (
    <div className="relative z-10 w-full max-w-7xl mx-auto px-12 pt-8 pb-12">
        <div className="flex justify-between items-start mb-16 gap-8">
            <div>
                <h1 className="text-5xl font-light tracking-tighter mb-2">DAY END REPORT</h1>
                <p className="text-xs uppercase tracking-[0.2em] text-zinc-400">Summary of daily operations.</p>
            </div>
        </div>
